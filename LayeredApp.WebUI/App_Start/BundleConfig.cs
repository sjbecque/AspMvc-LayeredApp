...
namespace LayeredApp.WebApp
{
	public class BundleConfig
	{
		// For more information on Bundling, visit http://go.microsoft.com/fwlink/?c
		public static void RegisterBundles(BundleCollection bundles)
		{
			...
			#region Scaffolding; is included in Asp.Net MVC 4 "Basic" template;
